                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            restaurentRecommeded[index].isBestSeller
                        ...
                        Text(
                          restaurentRecommeded[index].itemName,
                          style: TextStyle(
                        ...
                        Text(
                          "₹${restaurentRecommeded[index].price}",
                          style: TextStyle(
                        ...
                        Text(
                          restaurentRecommeded[index].description,
                          style:
