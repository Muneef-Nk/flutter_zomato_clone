...
import '../../../../screens/location_perlmision/locaton_permision.dart';
import '../../../model/home_slider.dart';
import '../../../model/horizontal_food_slider.dart';
import '../../../utils/color_constants.dart';
import '../../shared/widgets/chip_with_label.dart';
import '../../shared/widgets/chip_with_last_icon.dart';
import '../../shared/widgets/filter_chip.dart';
import '../../shared/widgets/profile.dart';
import '../../shared/widgets/rating_container.dart';
import '../../shared/widgets/show_language_bottom_sheet.dart';
import '../../shared/widgets/show_location_bottomsheet.dart';
...
import 'widgets/offer_text.dart';
import 'widgets/time_km_row.dart';
                            ...
                            return Stack(children: [
                              InkWell(
                                ...
                                child: Container(
                                  ...
                                  height: sliderHome[ConIndex].offerStatus
                                      ? 320
                                      : 290,
                                  decoration: BoxDecoration(
                                    color: Colors.white,
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            Text(
                                                "${sliderHome[ConIndex].item} • ",
                                                style: TextStyle(fontSize: 12)),
                                            Text(
                                                "${sliderHome[ConIndex].cato} • ",
                                                style: TextStyle(fontSize: 12)),
                                            Text(
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    "${sliderHome[index].amount} for one",
                                                    style: TextStyle(
                                                        color: Colors.grey,
                                                        fontSize: 12),
                                                  )
