                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        Text(
                                          '${diningRestoModel[index].km}km  • ',
                                          style: TextStyle(
                                              fontSize: 12, color: Colors.grey),
                                        ),
                                        Text(
                                          '${diningRestoModel[index].place}  • ',
                                          style: TextStyle(
                                              fontSize: 12, color: Colors.grey),
                                        ),
                                        Text(
                                          '₹${diningRestoModel[index].price} for two',
                                          style: TextStyle(
                                              fontSize: 12, color: Colors.grey),
                                        ),
                                      ],
                                  ...
                                  Padding(
                                    padding:
                                        const EdgeInsets.only(left: 20, top: 5),
                                    child: Text(
                                        'cafe ${diningRestoModel[index].foodIiem} Fast Food',
                                        style: TextStyle(
                                            fontSize: 13,
