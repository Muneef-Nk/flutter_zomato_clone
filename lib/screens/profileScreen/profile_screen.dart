            ...
            child: Row(
              children: [
                ...
                Column(
                  ...
                  children: [
                    Text("Muneef", style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold),),
                    Text("Muneef@gmail.com"),
                    Row(
                      children: [
                        Text("View activity", style: TextStyle(fontSize: 12, color: primary),),
      ...
      body: ListView(
        children: [
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              ProfileSmallContainer(text: "Like", icon: Icons.favorite_outline,),
              ProfileSmallContainer(text: "Payment", icon: Icons.payment,),
              ProfileSmallContainer(text: "Settings", icon: Icons.settings,),
            ],
          ),
          SizedBox(height: 10,),
          Container(
          ...
          Container(
            ...
            child: ListTile(
              leading: Container(
                ...
                child: Icon(Icons.star_outline, size: 15,),
              ),
                ...
                children: [
                  ListTile(
                    leading: Container(
                      ...
                      child: Icon(profileModel[index].icon, size: 15,),
                    ),
          ...
          GestureDetector(
            onTap: (){
              Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context)=>SignIn_SignUp()), (route) => false);
            },
            child: Container(
              height: 55,
              decoration: BoxDecoration(
              ...
              child: ListTile(
                leading: Container(
                  ...
                  child: Icon(Icons.power_settings_new, size: 15,),
                ),
                title: Text("Log out"),
                trailing: Icon(Icons.arrow_forward_ios, size: 18,color: Colors.black,),
              ),
